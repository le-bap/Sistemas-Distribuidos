...
#         tempo_ref = resposta.get("timestamp")
#         offset_relogio = tempo_ref - time.time()
#         print(f"[HEARTBEAT] tempo sincronizado: {tempo_ref}")
...
#     contador_server += 1
#     resposta['contador'] = contador_server
