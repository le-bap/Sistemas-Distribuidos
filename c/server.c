...
//     if (!f) {
//         perror("[ERRO] nao foi possivel abrir channels.txt para escrita");
//         return;
//     }
...
//     if (!f) {
//         perror("[ERRO] nao foi possivel abrir logins.txt para append");
//         return;
//     }
...
//     for (int i = 0; i < channel_count; i++) {
//         if (strcmp(channels[i], name) == 0) return 1;
//     }
//     return 0;
// }
...
//     msgpack_pack_str(pk, len);
//     msgpack_pack_str_body(pk, value, len);
// }
...
//                 pack_key_str(&pk, "message");
//                 pack_val_str(&pk, "canal ja existe");
...
//             for (int i = 0; i < channel_count; i++) {
//                 size_t len = strlen(channels[i]);
//                 msgpack_pack_str(&pk, len);
//                 msgpack_pack_str_body(&pk, channels[i], len);
//             }
